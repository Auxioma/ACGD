 ...
 */
final class Version20240203105956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, is_verified, nom, prenom, created_at, updated_at, deleted_at FROM user');
        ...
        $this->addSql('INSERT INTO user (id, email, roles, password, is_verified, nom, prenom, created_at, updated_at, deleted_at) SELECT id, email, roles, password, is_verified, nom, prenom, created_at, updated_at, deleted_at FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, is_verified BOOLEAN NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP --(DC2Type:datetime_immutable)
